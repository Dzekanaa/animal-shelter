...
public partial class UdruzenjaViewModel : ObservableObject
{
    ...
    public ICommand PregledIzvodaCommand { get; }
    ...
    public UdruzenjaViewModel()
    {
        ...
        PregledIzvodaCommand = new AsyncRelayCommand(PregledIzvodaAsync, () => AppSession.IsAdminUdruzenja);
    ...
    private async Task PrikaziMojeZivotinjeAsync()
    {
        ...
        var vm = new MojeZivotinjeViewModel(AppSession.CurrentUser.Id);
        var window = new MojeZivotinjeWindow { DataContext = vm };
        await window.ShowDialog(_ownerWindow);
    }
    
    private async Task PrikaziUdomiteljeAsync()
    {
        var vm = new UdomiteljiViewModel();
        var window = new UdomiteljiWindow { DataContext = vm };
        await window.ShowDialog(_ownerWindow);
    }
