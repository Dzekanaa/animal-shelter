...
public partial class AdoptionRequestEditorViewModel : ObservableObject
{
    [ObservableProperty]
    ...
    [ObservableProperty]
    private NacinObavestavanja? _nacinObavestavanja;
    ...
    public AdoptionRequestEditorViewModel()
    {
